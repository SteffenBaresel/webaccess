    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String Uid)
        ...
        if(Executions.UserIsPermitted(Uid,"liveticker")) {
            ...
            out.println(""
                    ...
                    + "            });\n"
                    /*
                     * Hier keine weiteren Java Script Funktionen einbinden. Beim nicht erfolgreichen anzeigen des Graphen werden alle Funktionen nach dieser nicht mehr ausgeführt.
                     */
                    + "\n"
                    + "        },\n"
                    + "        dataType: 'json',\n"
