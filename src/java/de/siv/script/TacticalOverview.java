    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String Uid)
        ...
        if(Executions.UserIsPermitted(Uid,"liveticker")) {
            ...
            out.println(""
                    ...
                    + "            $('#Nodes').append('<span style=\"float: left;\"><table cellpadding=0 cellspacing=0 border=0><tr><td colspan=3><span style=\"float: left;\">Alle Services</span><span style=\"float: left; margin-top: 0px;\" class=\"ui-icon ui-icon-triangle-1-s\"></span></td></tr><tr valign=middle><td class=\"' + socolor + '\"><b><a href=\"\">' + service_ok + '</a></b> Ok</td><td class=\"' + swcolor + '\"><b><a href=\"\">' + service_warn + '</a></b> Warnung</td><td class=\"' + sccolor + '\"><b><a href=\"\">' + service_crit + '</a></b> Kritisch</td><td class=\"' + sucolor + '\"><b><a href=\"\">' + service_unk + '</a></b> Unbekannt</td></tr></table></span>');\n"
                    + "\n"
        ...
        if(csw == 1) {
            ...
            out.println(""
                    ...
                    + "    $.ajax({\n"
                    + "        url: '/gateway/monitoring/ServiceDowntime?hstid=' + $.base64.encode( hstid ) + '&srvid=' + $.base64.encode( srvid ) + '&dstart=' + $.base64.encode( $('#' + dstart).val() ) + '&dend=' + $.base64.encode( $('#' + dend).val() ) + '&instid=' + $.base64.encode( instid ) + '&comment=' + $.base64.encode( $('#' + comment).val() ) + '&cuid=' + $.base64.encode( $('#' + cuid).val() ) + '&ccid=' + $.base64.encode( $('#' + ccid).val() ),\n"
                    + "        crossDomain: true,\n"
                    + "        success: function(json) {\n"
                    + "            if (json.EXEC == '1') {\n"
                    + "                DialogMailComplete(\"#DialogSuccess\",\"Aktion erfolgreich ausgef&uuml;hrt.\",\"Aktion erfolgreich ausgef&uuml;hrt.\");\n"
            ...
            out.println(""
                    ...
                    + "                $('#CreateServiceEntryDAselect').append('<option value=\"' + $.base64.decode( this.CCID ) + '\">' + $.base64.decode( this.COTRLN ) + ' (' + $.base64.decode( this.CCNR ) + ')</option>');\n"
                    + "            });\n"
                    + "        },\n"
                    + "        dataType: 'json',\n"
                    + "        cache: false\n"
           ...
           if(csw == 1) {
            ...
            out.println(""
                    ...
                    + "                        $('#ServiceInfoCoList').append('' + $.base64.decode( this.CUNM ) + ' (' + $.base64.decode( this.CUNR ) + ') -<br>' + $.base64.decode( this.CCNM ) + ' (' + $.base64.decode( this.CCNR ) + ')<br>');\n"
                    + "                    });\n"
                    + "                },\n"
                    + "                dataType: 'json',\n"
                    + "                cache: false,\n"
            ...
            out.println(""
                    ...
                    + "                        $('#CreateServiceEntryDSselect').append('<option value=\"' + $.base64.decode( this.CUID ) + '\">' + $.base64.decode( this.CUNM ) + '</option>');\n"
                    + "                    });\n"
                    + "                },\n"
                    + "                dataType: 'json',\n"
                    + "                cache: false\n"
