...
public class LoginError extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String e)
        ...
        out.println("    <title>Error Login - SuS-Reports</title>");
        ...
        out.println(""
                ...
                + "    $('input.login-input').addClass('ui-input-corner-all-error');\n"
        ...
        if ("2".equals(e)) {
            ...
            out.println(Html.printErrorBox("Der Anmeldeversuch schlug fehl! Bitte überprüfen Sie Benutzernamen und Kennwort. Wenden Sie sich bitte an Ihren LDAP/AD Administrator."));
        }
